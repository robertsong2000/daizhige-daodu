#!/usr/bin/env python3
# 引文核验+排版红线+mulu 连续性：劝学篇
import re, sys

SRC = "/home/robertsong/workspace/claude/daizhige-simplified/子藏/笔记/劝学篇.txt"
PAGE = "/home/robertsong/workspace/claude/daizhige-daodu/quxue-pian.html"
...
for cls in ["qsrc", "mono", "cplate", "axnode", "tnote", "hmeta", "chint", "kicker", "fnote", "who", "sno", "lbl", "lab", "zz", "lsrc", "day"]:
...
if 'href="quxue-pian.html"' not in mulu:
