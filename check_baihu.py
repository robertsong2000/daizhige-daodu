...
2. 白话反扫：其余文本（含JS字面量）按块切分，滑6字窗在库本中查撞。
3. 排版规则：禁长短划；每行·至多1个。
"""
import re, sys
from html.parser import HTMLParser

PAGE = '/home/robertsong/workspace/claude/daizhige-daodu/baihu-tongyi.html'
LIB = '/home/robertsong/workspace/claude/daizhige-simplified/史藏/志存记录/白虎通义.txt'
...
BLOCK = {'p','div','li','ul','section','footer','nav','h1','h2','h3','h4','h5','body','head','style','script','title','button','span','main','header','summary'}
