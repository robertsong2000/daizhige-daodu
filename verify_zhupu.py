#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""checker for zhupu-xianglu.html: 正扫 q/qv channels, 反扫 6-char windows."""
import re, sys, unicodedata
from html.parser import HTMLParser

PAGE = '/home/robertsong/workspace/claude/daizhige-daodu/zhupu-xianglu.html'
...
VOID = {'meta','link','br','hr','img','input','path','line','circle','text','rect','ellipse'}
class P(HTMLParser):
    def __init__(self):
