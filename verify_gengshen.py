#!/usr/bin/env python3
"""核验 gengshen-waishi.html 引文与库内原文逐字一致(去标点+NFKC+归一)"""
import re, sys, unicodedata

LIB = "/home/robertsong/workspace/claude/daizhige-simplified/史藏/志存记录/庚申外史.txt"
HTML = "/home/robertsong/workspace/claude/daizhige-daodu/gengshen-waishi.html"
...
# ── 5. 结构断言 ──
if "殆知阁导读之一百五十二" not in raw:
    print("FAIL 结构: 标题缺导读编号之一百五十二")
    fail += 1
