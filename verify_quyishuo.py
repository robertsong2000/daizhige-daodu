# -*- coding: utf-8 -*-
"""祛疑说导读页校验：引文正扫比对 + 全文反扫 + 排版规则。"""
import re, sys, unicodedata

SRC = '/home/robertsong/workspace/claude/daizhige-simplified/子藏/笔记/祛疑说.txt'
HTML = '/home/robertsong/workspace/claude/daizhige-daodu/quyishuo.html'
...
# ---- 3. 排版规则 ----
bad_dash = [m for m in ('—', '–', '一\\u2014') if m in page] + (['–'] if '–' in page else [])
