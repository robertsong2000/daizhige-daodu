#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""checker for tanglv.html: 正扫 q/qv channels, 反扫 6-char windows."""
import re, sys, unicodedata
from html.parser import HTMLParser

PAGE = '/home/robertsong/workspace/claude/daizhige-daodu/tanglv.html'
SRC  = '/home/robertsong/workspace/claude/daizhige-simplified/史藏/政书/唐律疏议.txt'

def norm(s):
    out = []
    for ch in s:
        o = ord(ch)
        if 0xE000 <= o <= 0xF8FF: continue          # PUA
...
# ---- rule: at most one · per source line ----
bad = 0
...
class P(HTMLParser):
    def __init__(self):
        ...
        self.prose = []          # text outside channels
        self.channels = []       # (channel normalized text)
        self.in_skip = 0         # style/script
        self.cur = None          # text buffer for open channel depth
        self.depth_chan = 0
        self.title_buf = []
        self.in_title = False
