#!/usr/bin/env python3
# 引文核验+排版红线+mulu 连续性：炀帝开河记
import re, sys

SRC = "/home/robertsong/workspace/claude/daizhige-simplified/子藏/笔记/炀帝开河记.txt"
PAGE = "/home/robertsong/workspace/claude/daizhige-daodu/kaihe-ji.html"
...
for cls in ["qsrc", "mono", "cplate", "axnode", "tnote", "hmeta", "chint", "kicker", "fnote", "who", "sno", "lbl", "lab", "zz", "lsrc", "day", "corr"]:
...
if 'href="kaihe-ji.html"' not in mulu:
