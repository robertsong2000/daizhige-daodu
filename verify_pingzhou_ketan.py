#!/usr/bin/env python3
# 萍洲可谈导读页核验：引文双向比对 + 排版红线
import re, sys

SRC = '/home/robertsong/workspace/claude/daizhige-simplified/史藏/志存记录/萍洲可谈.txt'
PAGE = '/home/robertsong/workspace/claude/daizhige-daodu/pingzhou-ketan.html'
...
# 1. 引文 -> 库内
qts = re.findall(r'<span class="qt">(.*?)</span>', html, re.S)
fails = 0
